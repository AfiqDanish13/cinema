...
if(empty($_GET))
{
	$tarikhtayang=date("Y-m-d");
}
else
{
	$tarikhtayang=$_GET['tarikh'];
}
...
<head>
  ...
  <nav class="navbar">
    ...
    <div class="switch">
      <a href="belisekarang_jadual.php"><i class="fas fa-moon"></i></a> 
    </div>
  
    <main>

    <div class="content">
        <div class="title">JADUAL PENAYANGAN</div>
	...
	<form action=' ' method='GET'>
			...
			<input type="date" name='tarikh' min='<?php echo date("Y-m-d"); ?>'
			value='<?php echo $tarikh_pilihan; ?>'>
	...
	?>
      ...
      <td><?php echo $cinema['tajuk']; ?></td>
			...
			<td><a href="belisekarang_seat_light.php?idjadual=<?php echo $cinema['idjadual'];?>">
		        <img src=buy.png>
	            </td>
			</tr>
			<?php $bil = $bil + 1; } ?>
