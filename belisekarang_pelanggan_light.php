...
if(isset($_POST['notel'])) {
	...
	echo "<script>window.location = 'belisekarang_jadual_light.php'</script>";
}
?>
...
<head>
  ...
  <nav class="navbar">
    ...
    <div class="switch">
      <a href="belisekarang_pelanggan_light.php"><i class="fas fa-moon"></i></a> 
    </div>
	...
	<a href="belisekarang_jadual_light.php" class="button">Sudah Berdaftar</a>
	</form>
    </div>
