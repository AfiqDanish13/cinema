...
if(isset($_POST['idfilem'])) {
	...
	if($result)
		...
		echo "<script>alert('Tidak berjaya membuat jadual penayangan')</script>";
...
<head>
  ...
  <body>
    ...
    <div class="switch">
      <a href="jadual_insert_light.php"><i class="fas fa-sun"></i></a> 
    </div>
    <main>
    <div class="content">
		...
		<div class="table">
		<form class="jadual" action="jadual_insert.php" method="post">
    <table>
	<tr>
	<td>Filem</td>
	<td>
