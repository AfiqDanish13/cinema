...
if(isset($_POST['idfilem'])) {
            $tarikhtayang = $_POST['tarikhtayang'];
            $masatayang = $_POST['masatayang'];
            $idfilem = $_POST['idfilem'];
            $idbilik = $_POST['idbilik'];
	$sql = "insert into jadual values(NULL,'$idfilem','$idbilik','$tarikhtayang','$masatayang')";
	$result = mysqli_query($sambungan,$sql);
	if($result)
		echo "<script>alert('Berjaya Menambah Jadual Penayangan')</script>";
	else
		echo "<script>alert('Tidak Berjaya Menambah Jadual Penayangan')</script>";
...
<head>
    ...
    <title>Tambah Jadual Penayangan</title>
  </head>
  ...
  <nav class="navbar">
    ...
    <div class="switch">
      <a href="jadual_insert.php"><i class="fas fa-moon"></i></a> 
    </div>
  
    <main>
    <div class="content">
        <div class="title">TAMBAH JADUAL</div>
        
    </div>
    
    
		<div class="table">
		<form class="jadual" action="jadual_insert_light.php" method="post">
    <table>
	  <tr>
	  <td>Filem</td>
	  <td>
    ...
    <tr>
		...
		<td><input type="date" name="tarikhtayang"></td>
	</tr>
	<tr>
    <tr>
	    <td>Masa Tayangan</td>
		<td><input type="time" name="masatayang"></td>
	</tr>
	...
	<td>
		...
		<?php 
			...
			while($bilik = mysqli_fetch_array($data2)) {
