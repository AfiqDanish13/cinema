...
<head>
  ...
  <nav class="navbar">
    ...
    <div class="switch">
      <a href="jadual_senarai.php"><i class="fas fa-moon"></i></a> 
    </div>
  
    <main>
    <div class=button>
        <a href="jadual_insert_light.php" class="btn">Tambah Jadual</a>
       </div>
...
?>
    <tr>
		...
		<td>
		<a href="jadual_update_light.php?idjadual=<?php echo $cinema['idjadual'];?>">
		<img src=update.png>
		<a href="jadual_delete_light.php?idjadual=<?php echo $cinema['idjadual'];?>">
		<img src=delete.png>
		</a>
		</td>
	</tr>
