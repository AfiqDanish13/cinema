...
<head>
  ...
  <nav class="navbar">
    ...
    <div class="switch">
      <a href="laporan_pilihan.php"><i class="fas fa-moon"></i></a> 
    </div>
  
    <main>
    <div class="content">
        <div class="title">PILIHAN LAPORAN</div>
        
    </div>
    
    
		<div class="table">
    <form action="laporan_senarai_light.php" method="post">
		<table>
			<tr>
			  <th>Filem</th>
				<th>Bulan</th>
			...
			<td><select name="idfilem">
				...
				<td><select name ="bulan">
					...
					$bulan = array("Januari","Februari","Mac","April","Mei","Jun","July","Ogos","September","Oktober","November","Disember");
					for($i = 0; $i < 12; $i++ ) {
						$b = $i + 1;
				...
				<td><select name="pilihan">
				  <option value=1>Semua Filem, Semua Bulan</option>
					<option value=2>Mengikut Filem</option>
    ...
    <button class="papar" type="submit" style="margin-top:20px;">Papar</button>
    </form>
	</div>
