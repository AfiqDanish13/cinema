...
<head>
    ...
    <link rel="stylesheet" href="senarai_light.css" />
    <link
  ...
  <?php
   ...
   $bulan = $_POST["bulan"];
  $tahun = 2020;
  $senarai = array("DUMMY","JAN","FEB","MAC","APRIL","MEI","JUN","JUL","OGOS","SEP","OKT","NOV","DIS");
  $namabulan = $senarai[$bulan];
  $sql = "select * from pembelian join pelanggan on pembelian.notel = pelanggan.notel 
  join jadual on pembelian.idjadual = jadual.idjadual 
  ...
  ";
	...
	switch ($pilihan) {
		...
		case 2 : $syarat = " where jadual.idfilem = '$idfilem' ";
        $tajuk = "LAPORAN MENGIKUT FILEM"; break;
    case 3 : $syarat = " where MONTH(tarikhpembelian) = $bulan ";
  ...
  $jumlah_keuntungan = 0;
	...
	<tr>
	    <td colspan="6" align="right" bgcolor="red">JUMLAH KESELURUHAN</td>
		<td bgcolor="red">RM <?php echo number_format($jumlah_keseluruhan,2);?></td>
	</tr>
	<tr>
	    <td colspan="6" align="right" bgcolor="green" >JUMLAH KEUNTUNGAN (40%)</td>
		<td bgcolor="green">RM <?php echo number_format($jumlah_keuntungan,2);?></td>
	</tr>
  <caption><?php echo $tajuk; ?></caption>
</table>
<a href="laporan_cetak.php?syarat=<?php echo $syarat ?>" class="btn" target=_blank style="left: 45%;">CETAK</a>
<div class="footer">
