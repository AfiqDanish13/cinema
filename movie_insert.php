...
<head>
  ...
  <body>
    ...
    <div class="switch">
      <a href="movie_insert_light.php"><i class="fas fa-sun"></i></a> 
    </div>
    ...
    <div class="content">
		...
		<div class="table">
        <form action="movie_insert.php" method="post" enctype="multipart/form-data" class="filem">
        <table>
	    <tr>
		<td> Tajuk </td>
        ...
        <a href="movie_import.html" class="button">Import</a>
	    </form>
