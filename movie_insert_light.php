...
if(isset($_POST['tajuk'])) {
    ...
    $sql = "INSERT INTO `filem`(`idfilem`, `tajuk`, `poster`, `durasi`, `harga`, `tarikhditambah`) VALUES (NULL,'$tajuk','$filename','$durasi','$harga','$dateNow')";
	$result = mysqli_query($sambungan,$sql);
	if($result)
	    echo "<script>alert('Berjaya Menambah Filem')</script>";
	else
	    echo "<script>alert('Tidak Berjaya Menambah Filem')</script>";
...
<head>
  ...
  <nav class="navbar">
    ...
    <div class="switch">
      <a href="movie_insert.php"><i class="fas fa-moon"></i></a> 
    </div>
  
    <main>
    <div class="content">
        <div class="title">TAMBAH FILEM</div>
        
    </div>
    
    
		<div class="table">
    <form action="movie_insert_light.php" method="post" enctype="multipart/form-data" class="filem">
    <table>
	  <tr>
		<td> Tajuk </td>
		<td> <input type="text" name="tajuk" placeholder="AVENGERS"> </td>
		</tr>
		<tr>
		<td>Poster</td>
        ...
        <tr>
		<td> Durasi </td>
		<td> <input type="text" name="durasi" placeholder="2 jam 30 minit"> </td>
		</tr>
		<tr>
        <tr>
		<td> Harga </td>
		<td> <input type="text" name="harga" placeholder="RM13.00"> </td>
		</tr>
		<tr>
	    </table>
        <button class="tambah" type="summit">Tambah</button>
        <a href="movie_import_light.html" class="button">Import</a>
	    </form>
