...
<head>
  ...
  <body>
    ...
    <div class="switch">
      <a href="movie_senarai_light.php"><i class="fas fa-sun"></i></a> 
    </div>
  
    <main>
    <div class="button">
        <a href="movie_insert.php" class="btn">Tambah Filem</a>
       </div>
    ...
    <div class="content">
		...
		<table>
			...
			<tr>
				...
				<td>
				    <a href="movie_update.php?idfilem=<?php echo $cinema['idfilem'];?>">
					<img src=update.png>
					</a>
					<a href="movie_delete.php?idfilem=<?php echo $cinema['idfilem'];?>">
					<img src=delete.png>
					</a>
				</td>
			</tr>
