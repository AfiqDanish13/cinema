...
<head>
  ...
  <nav class="navbar">
    ...
    <div class="switch">
      <a href="movie_senarai.php"><i class="fas fa-moon"></i></a> 
    </div>
  
    <main>
    <div class="button">
        <a href="movie_insert_light.php" class="btn">Tambah Filem</a>
       </div>


    <div class="content">
        <div class="title">SENARAI FILEM</div>
		...
		<table>
			...
			<?php
			$sql= "select * from filem ORDER BY tarikhditambah ASC";
			...
			<tr>
				...
				<td>RM <?php echo $cinema['harga'];?></td>
				<td><?php echo date("d/m/y", strtotime($cinema['tarikhditambah']));?></td>
				<td>
				    <a href="movie_update_light.php?idfilem=<?php echo $cinema['idfilem'];?>">
					<img src=update.png>
					</a>
					<a href="movie_delete_light.php?idfilem=<?php echo $cinema['idfilem'];?>">
					<img src=delete.png>
					</a>
				</td>
			</tr>
