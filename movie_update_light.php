...
if(isset($_POST['idfilem'])) {
	...
	$durasi = $_POST['durasi'];
	$harga = $_POST['harga'];
	$tarikhditambah = $_POST['tarikhditambah'];
	$sql = "update filem set tajuk='$tajuk', durasi='$durasi', harga='$harga', tarikhditambah='$tarikhditambah' where idfilem='$idfilem'";
...
$sql = "select * from filem where idfilem = '$idfilem'";
$result = mysqli_query($sambungan, $sql);
while($filem = mysqli_fetch_array($result)) {
	$tajuk = $filem['tajuk'];
    $durasi = $filem['durasi'];
	$harga = $filem['harga'];
	$tarikhditambah = $filem['tarikhditambah'];
}
?>
<head>
  ...
  <nav class="navbar">
    ...
    <main>
    <div class="content">
        <div class="title">KEMASKINI FILEM</div>
        
    </div>
    
    
		<div class="table">
		<form action="movie_update_light.php" method="post" class="filem">
	<table>
	    <tr>
		<td>ID FILEM</td>
		<td><input class="readonly" readonly type="text" name="idfilem" value='<?php echo $idfilem;?>'></td>
		</tr>
		<tr>
		<td>Tajuk</td>
		...
		<tr>
		<td>Tarikh Ditambah</td>
		<td><input type="date" name="tarikhditambah" value="<?php echo $tarikhditambah;?>"></td>
		</tr>
		<tr>
		<tr>
	</table>
