...
<head>
  ...
  <body>
    ...
    <div class="switch">
      <a href="pelanggan_insert_light.php"><i class="fas fa-sun"></i></a> 
    </div>
    ...
    <div class="content">
		...
		<div class="table">
		<form action="pelanggan_insert.php" method="post" class="pelanggan">
    <table>
	  <tr>
		<td> No. Tel </td>
		...
		<tr>
		<td> Nama</td>
		<td> <input type="text" name="nama" placeholder="Afiq Danish" required=""> </td>
		</tr>
	</table>
  <button class="tambah" type="submit">Tambah</button>
<a href="pelanggan_import.html" class="button">Import</a>
	</form>
