...
<head>
  ...
  <nav class="navbar">
    ...
    <div class="switch">
      <a href="pelanggan_insert.php"><i class="fas fa-moon"></i></a> 
    </div>
    ...
    <div class="content">
		...
		<div class="table">
		<form action="pelanggan_insert_light.php" method="post" class="pelanggan">
    <table>
	    <tr>
		    <td> No. Tel </td>
		    <td> <input type="text" name="notel" maxlength="11" minlength="10" placeholder="013-6732814" required=""> </td>
		  </tr>
		  <tr>
		    <td> Nama</td>
    ...
    <a href="pelanggan_import_light.html" class="button">Import</a>
	  </form>
