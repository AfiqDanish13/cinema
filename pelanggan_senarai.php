...
<head>
  ...
  <body>
    ...
    <div class="switch">
      <a href="pelanggan_senarai_light.php"><i class="fas fa-sun"></i></a> 
    </div>
  
    <main>
    <div class=button>
        <a href="pelanggan_insert.php" class="btn">Tambah Pelanggan</a>
       </div>
	...
	<tr>
		...
		<td>
		<a href="pelanggan_update.php?notel=<?php echo $cinema['notel'];?>">
		<img src=update.png>
		<a href="pelanggan_delete.php?notel=<?php echo $cinema['notel'];?>">
		<img src=delete.png>
		</a>
	</td>
</tr>
