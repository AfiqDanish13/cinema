...
<head>
  ...
  <nav class="navbar">
    ...
    <div class="switch">
      <a href="pelanggan_senarai.php"><i class="fas fa-moon"></i></a> 
    </div>
  
    <main>
    <div class=button>
        <a href="pelanggan_insert_light.php" class="btn">Tambah Pelanggan</a>
       </div>

    <div class="content">
        <div class="title">SENARAI PELANGGAN</div>
	...
	<tr>
	    <td><?php echo $bil; ?></td>
		<td><?php echo $cinema['notel']; ?></td>
		<td><?php echo $cinema['nama']; ?></td>
		<td>
		<a href="pelanggan_update_light.php?notel=<?php echo $cinema['notel'];?>">
		<img src=update.png>
		<a href="pelanggan_delete_light.php?notel=<?php echo $cinema['notel'];?>">
		<img src=delete.png>
		</a>
	</td>
</tr>
