...
if(isset($_POST['notel'])){
	 $notel = $_POST['notel'];
	 $nama = $_POST['nama'];
	 $sql = "update pelanggan set nama='$nama' where notel='$notel'";
...
$notel = $_GET['notel'];
$sql = "select * from pelanggan where notel = '$notel'";
$result = mysqli_query($sambungan,$sql);
...
<head>
    ...
    <title>Kemaskini Pelanggan</title>
  </head>
  ...
  <nav class="navbar">
    ...
    <main>
    <div class="content">
        <div class="title">KEMASKINI PELANGGAN</div>
        
    </div>
    
    
		<div class="table">
		<form action="pelanggan_update_light.php" method="POST" class="pelanggan">
	     <table>
			 <tr>
			     <td>No Tel:</td>
				 <td><input class="readonly" readonly type="text" name="notel" value='<?php echo $notel; ?>'></td>
			 </tr>
			 <tr>
			     <td>Nama:</td>
