...
<head>
  ...
  <body>
    ...
    <div class="switch">
      <a href="pembelian_senarai_light.php"><i class="fas fa-sun"></i></a> 
    </div>
  
    <main>
    <div class=button>
        <a href="belisekarang_jadual.php" class="btn">Tambah Pembelian</a>
       </div>
...
?>
    ...
    <td><?php echo date("d/m/y", strtotime($pembelian['tarikhpembelian'])); ?></td>		<td>
		    <a href="pembelian_delete.php?idpembelian_form=<?php echo $pembelian['idpembelian'];?>">
			<img src="delete.png">
			</a>
