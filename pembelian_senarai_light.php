...
<head>
  ...
  <nav class="navbar">
    ...
    <div class="switch">
      <a href="pembelian_senarai.php"><i class="fas fa-moon"></i></a> 
    </div>
  
    <main>
    <div class=button>
        <a href="belisekarang_jadual_light.php" class="btn">Tambah Pembelian</a>
       </div>

    <div class="content">
        <div class="title">SENARAI PEMBELIAN</div>
...
?>
    <tr>
		...
		<td><?php echo date("d/m/y", strtotime($pembelian['tarikhtayang'])); ?></td>
		<td><?php echo $pembelian['masatayang']; ?></td>
		<td><?php echo $pembelian['kuantiti']; ?></td>
		<td><?php echo $pembelian['namabilik']; ?></td>
		<td><?php echo $pembelian['notempatduduk']; ?></td>
    <td><?php echo date("d/m/y", strtotime($pembelian['tarikhpembelian'])); ?></td>		<td>
		    <a href="pembelian_delete_light.php?idpembelian_form=<?php echo $pembelian['idpembelian'];?>">
			<img src="delete.png">
			</a>
			<a href="cetak_resit.php?idpembelian_form=<?php echo $pembelian['idpembelian'];?>">
			<img src="printer.png">
			</a>
		</td>
	</tr>
